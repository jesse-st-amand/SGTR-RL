...
def generate_summary_plot(run_dir: str | Path) -> Path:
    ...
    ax.plot(train_epochs, train_nll_arr, alpha=0.3, color="C0", linewidth=0.8)
    ax.plot(train_epochs, _smooth(train_nll_arr), color="C0", linewidth=1.5, label="train NLL (smoothed)")
    ax.plot(val_epochs, val_nll_list, "o-", color="C1", markersize=4, linewidth=1.5, label="val NLL")
    ...
    ax.plot(train_epochs, train_acc_arr, alpha=0.3, color="C0", linewidth=0.8)
    ax.plot(train_epochs, _smooth(train_acc_arr), color="C0", linewidth=1.5, label="train acc (smoothed)")
    ax.plot(val_epochs, val_acc_list, "o-", color="C1", markersize=4, linewidth=1.5, label="val acc")
